...
def scmcust_macro_scm_apply_tags():
    ...
    def run_macro(**context):
        # ✅ Read from trigger JSON config first, fallback to Airflow Variables
        ...
        # ✅ Only pass args that have values — macro uses its own defaults for None
        macro_args = {}
        ...
        print(f"Running macro scm_apply_tags with args: {macro_args}")  # ✅ visible in logs
    ...
    PythonOperator(
        ...
        provide_context=True,   # ✅ ensures **context gets dag_run.conf
    )
